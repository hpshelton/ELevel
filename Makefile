...
# Generated by qmake (2.01a) (Qt 4.6.0) on: Wed Jan 13 22:04:30 2010
# Project:  ELevel.pro
# Template: app
...
SOURCES       = src/dataModel/card.cpp \
		...
		src/elevel/cardAreaGUI.cpp obj/moc_mainWindow.cpp \
...
dist: 
	...
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/ELevel1.0.0/ && $(COPY_FILE) --parents src/defines.h src/dataModel/card.h src/dataModel/cardSection.h src/dataModel/deck.h src/dataModel/testStat.h src/editCard/drawingGraphicsScene.h src/editCard/drawingGraphicsView.h src/elevel/mainWindow.h src/elevel/viewState.h src/elevel/cardAreaGUI.h obj/ELevel1.0.0/ && $(COPY_FILE) --parents src/ELevel.qrc obj/ELevel1.0.0/ && $(COPY_FILE) --parents src/dataModel/card.cpp src/dataModel/cardSection.cpp src/dataModel/deck.cpp src/dataModel/testStat.cpp src/elevel/elevel.cpp src/elevel/mainWindow.cpp src/elevel/viewState.cpp src/editCard/drawingGraphicsView.cpp src/elevel/cardAreaGUI.cpp obj/ELevel1.0.0/ && (cd `dirname obj/ELevel1.0.0` && $(TAR) ELevel1.0.0.tar ELevel1.0.0 && $(COMPRESS) ELevel1.0.0.tar) && $(MOVE) `dirname obj/ELevel1.0.0`/ELevel1.0.0.tar.gz . && $(DEL_FILE) -r obj/ELevel1.0.0
...
compiler_moc_header_make_all: obj/moc_mainWindow.cpp obj/moc_viewState.cpp obj/moc_cardAreaGUI.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) obj/moc_mainWindow.cpp obj/moc_viewState.cpp obj/moc_cardAreaGUI.cpp
