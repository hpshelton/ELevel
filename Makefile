#############################################################################
# Makefile for building: ELevel.app/Contents/MacOS/ELevel.app
# Generated by qmake (2.01a) (Qt 4.6.0) on: Wed Jan 13 16:39:21 2010
# Project:  ELevel.pro
# Template: app
...
SOURCES       = src/dataModel/card.cpp \
		...
		src/editCard/drawingGraphicsView.cpp obj/moc_mainWindow.cpp \
...
DIST          = /usr/local/Qt4.6/mkspecs/common/unix.conf \
		...
		ELevel.pro
QMAKE_TARGET  = ELevel.app
DESTDIR       = 
TARGET        = ELevel.app/Contents/MacOS/ELevel.app
...
ELevel.app/Contents/Info.plist: 
	...
	@sed -e "s,@ICON@,,g" -e "s,@EXECUTABLE@,ELevel.app,g" -e "s,@TYPEINFO@,????,g" /usr/local/Qt4.6/mkspecs/macx-g++/Info.plist.app >ELevel.app/Contents/Info.plist
dist: 
	@$(CHK_DIR_EXISTS) obj/ELevel.app1.0.0 || $(MKDIR) obj/ELevel.app1.0.0 
	$(COPY_FILE) --parents $(SOURCES) $(DIST) obj/ELevel.app1.0.0/ && $(COPY_FILE) --parents src/defines.h src/dataModel/card.h src/dataModel/cardSection.h src/dataModel/deck.h src/dataModel/testStat.h src/editCard/drawingGraphicsScene.h src/editCard/drawingGraphicsView.h src/elevel/mainWindow.h src/elevel/viewState.h obj/ELevel.app1.0.0/ && $(COPY_FILE) --parents src/ELevel.qrc obj/ELevel.app1.0.0/ && $(COPY_FILE) --parents src/dataModel/card.cpp src/dataModel/cardSection.cpp src/dataModel/deck.cpp src/dataModel/testStat.cpp src/elevel/elevel.cpp src/elevel/mainWindow.cpp src/elevel/viewState.cpp src/editCard/drawingGraphicsView.cpp obj/ELevel.app1.0.0/ && (cd `dirname obj/ELevel.app1.0.0` && $(TAR) ELevel.app1.0.0.tar ELevel.app1.0.0 && $(COMPRESS) ELevel.app1.0.0.tar) && $(MOVE) `dirname obj/ELevel.app1.0.0`/ELevel.app1.0.0.tar.gz . && $(DEL_FILE) -r obj/ELevel.app1.0.0
...
compiler_moc_header_make_all: obj/moc_mainWindow.cpp obj/moc_viewState.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) obj/moc_mainWindow.cpp obj/moc_viewState.cpp
